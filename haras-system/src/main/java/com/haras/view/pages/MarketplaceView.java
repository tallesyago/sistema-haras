...
public class MarketplaceView {
    ...
    public JPanel getContentPanel() {
        ...
        FontIcon marketIcon = FontIcon.of(FontAwesomeSolid.SHOPPING_CART, 32, new Color(245, 158, 11));
        JLabel iconLabel = new JLabel();
        iconLabel.setIcon(marketIcon);
        ...
        FontIcon emptyIcon = FontIcon.of(FontAwesomeSolid.SHOPPING_CART, 48, new Color(209, 213, 219));
        JLabel emptyIconLabel = new JLabel();
        emptyIconLabel.setIcon(emptyIcon);
        emptyIconLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel descLabel = new JLabel("Compre e venda cavalos, equipamentos e serviços");
