...
public class HistoricoVeterinarioView {
    ...
    public JPanel getContentPanel() {
        ...
        FontIcon medicalIcon = FontIcon.of(FontAwesomeSolid.STETHOSCOPE, 32, new Color(59, 130, 246));
        JLabel iconLabel = new JLabel();
        iconLabel.setIcon(medicalIcon);
        ...
        FontIcon emptyIcon = FontIcon.of(FontAwesomeSolid.STETHOSCOPE, 48, new Color(209, 213, 219));
        JLabel emptyIconLabel = new JLabel();
        emptyIconLabel.setIcon(emptyIcon);
        emptyIconLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel descLabel = new JLabel("Acompanhe consultas, vacinas e tratamentos dos cavalos");
